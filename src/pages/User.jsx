...
function User() {
    ...
    const { getUserAndRepos, user, loading, repos } = useContext(GithubContext)
        ...
        <div className="w-full mx-auto lg:w-10/12">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
                ...
                <div className="custom-card-image mb-6 md:mb-0">
                    <div className="rounded-lg shadow-xl card image-full grid-flow-col">
                        ...
                        <div className="card-body justify-end card-content text-lime-500" style={{ color: "white" }}>
                ...
                <div className="col-span-2">
                    <div className="mb-6">
                        ...
                        <div className="mt-4 card-actions">
                            {/*NOTE in anchor tags, target='_blank' attribute must always have rel='noreferrer' */}
            ...
            {/* stat class is a daisy-ui something */}
